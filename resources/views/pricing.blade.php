...
@section('content')
         <div class=" aboutother-banniere aboutother-banniere-pricing container-fuild py-5">
...
<main class="pricing-other">
  <section id="pricing-information">
    <div class=" container" data-aos="fade-up">
      ...
      <div class="row py-2">
        ...
        <div class="col row mx-2 py-3 shadow p-3 mb-5 bg-body rounded website-development">
          ...
          <div class="col-8">
            <p>
            We design responsive and quality websites and web application for various purposes and also serve...
        ...
        <div  class="col row mx-2 shadow p-3 mb-5 bg-body rounded website-maintenance">
          ...
          <div class="col-8">
            <p>
              Keeping your website up and running lies on only one thing, that is giving it a proper maintenance...
            </p>
        ...
        <div  class="col row mx-2 shadow p-3 mb-5 bg-body rounded social-management">
          ...
          <div class="col-8">
            <p>
            Qavaa group helps you manage your social presence. We're a mission-driven team that provides...
            </p>
            <a class="btn boutton-subscribe d-block mx-auto mt-4" href="service#media" >Learn more</a>
   ...
   <!-- ======= About Us Section ======= -->
  <section id="about " class="price about ">
    <div class="container" data-aos="fade-up">
      <div class="text-center mb-5">
        <h2 class="text-center">Lorem, ipsum.</h2>
      </div>
      ...
      <div class="mx-auto">
        <div class="row">
          ...
          <div class="col-lg-4 text-center " data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <div class="row pt-0">
                <div class="col">
                <h3>Lite</h3>
                <h6>From <sup>$</sup>29.99 </h6>
                </div>
                /
                <div class="col">
                <h3>Medium</h3>
                <h6>From <sup>$</sup>49.99 </h6>
                </div>
              </div>
              <ul>
                <li class="px-0 fw-bold text-center"> Included Functions</li>
                <div class="row pt-0">
                  <div class="col">
                    <li><i class="bx bx-check"></i> 2 Flyers</li>
                    <li><i class="bx bx-check"></i> 1 Video</li>
                    <li class="na"><i class="bx bx-x"></i> <span>Articles</span></li>
                    <li class="na"><i class="bx bx-x"></i> <span>Caroussel</span></li>
                  </div>
                  
                  <div class="col">
                    <li><i class="bx bx-check"></i> 4 Flyers</li>
                    <li><i class="bx bx-check"></i> 2 Video</li>
                    <li class="na"><i class="bx bx-x"></i> <span>Articles</span></li>
                  <li class="na"><i class="bx bx-x"></i> <span>Caroussel</span></li>
                  </div>
                </div>
                 
                <li class="px-0 fw-bold text-center">Optional Function</li>
                <div class="row pt-0">
                  <div class="col-12 text-center">
                    <li><i class="bx bx-check"></i> Advertising campaign</li>
                    <li><i class="bx bx-check"></i>Reply to messages and comments</li>
                    <li class="na"><i class="bx bx-x"></i><span>More Advertising campaign</span> </li>
                    <li class="na"><i class="bx bx-x"></i><span>Referencing management</span></li>
                    <li class="na"><i class="bx bx-x"></i><span>Analysis extraction</span></li>
                    <li class="na"><i class="bx bx-x"></i><span>Chat</span></li>
                  </div>
                  <!--div class= " col ">
                    <li><i class="bx bx-check"></i> Advertising campaign</li>
                    <li><i class="bx bx-check"></i>Reply to messages and comments</li>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0 text-center" data-aos="fade-up" data-aos-delay="200">
            <div class="box featured">
              <h3>Premium</h3>
              <h6>From <sup>$</sup>69.99 </h6>
              <ul>
                <li class="px-0 fw-bold text-center"> Included Functions</li>
                  <li><i class="bx bx-check"></i> 12 Flyers</li>
                  <li><i class="bx bx-check"></i> 4 Video</li>
                  <li ><i class="bx bx-check"></i> <span>2 Articles</span></li>
                  <li><i class="bx bx-check"></i> <span>1 Caroussel</span></li>
                  <li><i class="bx bx-check"></i> Advertising campaign</li>
                  <li><i class="bx bx-check"></i>Reply to messages and comments</li>
                <li class="px-0 fw-bold text-center">Optional Function</li>
                
                  <li><i class="bx bx-check"></i> More Advertising campaign</li>
                  <li><i class="bx bx-check"></i>Referencing management</li>
                  <li><i class="bx bx-check"></i>Analysis extraction</li>
                  <li><i class="bx bx-check"></i>Chat</li>
              </ul>
              <a href="#" class="buy-btn">Get Started</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 text-center " data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              <h3>Custom</h3>
              <h6>From <sup>$</sup>99.99 </h6>
              <ul>
                <li class="px-0 fw-bold text-center"> Included Functions</li>
                  <li><i class="bx bx-check"></i> 16 Flyers</li>
                  <li><i class="bx bx-check"></i> 8 Video</li>
                  <li ><i class="bx bx-check"></i> <span>4 Articles</span></li>
                  <li><i class="bx bx-check"></i> <span>4 Caroussel</span></li>
                  <li><i class="bx bx-check"></i>2 Advertising campaign</li>
                  <li><i class="bx bx-check"></i>Reply to messages and comments</li>
                  <li><i class="bx bx-check"></i>Analysis extraction</li>
                <li class="px-0 fw-bold text-center">Optional Function</li>
              ...
              <div class="row">
                ...
                <div class="col-lg-4 text-center " data-aos="fade-up" data-aos-delay="100">
                  <div class="box">
                    ...
                    <ul>
                      <li class="px-0 fw-bold text-center"> Page creation & Update</li>
                          <li><i class="bx bx-check"></i>Page creation (1 per year)</li>
